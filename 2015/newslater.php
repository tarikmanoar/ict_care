...
<div class="content-inner">
    <div class="container-fluid">
                ...
                <div class="widget has-shadow">
                    <div class="widget-body">
                        <div class="table-responsive">
                            <table id="sorting-table" class="table mb-0 table-hover table-inverse">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Email</th>
                                ...
                                <tbody>
                            <?php 
                                $select_cat = "SELECT * FROM newsletter";
                                ...
                                while ($row = mysqli_fetch_assoc($cat_sql)):?>
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            <a href="newslater.php?delete=<?php echo $row['id'] ?>"><i class="la la-close delete"></i></a>
                                        </td>
                                    </tr>
                            <?php endwhile ?>
                                </tbody>
        ...
        if (isset($_GET['delete'])) {
             $id = $_GET['delete'];
             $deleteSql = "DELETE FROM newsletter WHERE id='$id'";
             $deletQuery = query($deleteSql);
             if (!$deletQuery) {
                 die("DELETION FAELD " . mysqli_error($dbconn));
             }else {
                 header("Location: newslater.php");
             }
         } ?>
        <!-- End Row -->
    </div>
