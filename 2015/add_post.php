                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal dropzone">
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-3 form-control-label">Post Title</label>
                                <div class="col-lg-9">
                                    <input type="text" name="title" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-3 form-control-label">Post Content</label>
                                <div class="col-lg-9">
                                    <textarea name="post-content" id="" class="form-control" cols="30" rows="10"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-3 form-control-label">Featured Image</label>
                                <div class="col-lg-9">
                                    <input type="file" name="photo" placeholder="placeholder" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="tags" placeholder="placeholder" class="form-control">
                                </div>
                            </div>
...
<script src="assets/vendors/js/dropzone.min.js"></script>
<!-- End Vendor Js -->
